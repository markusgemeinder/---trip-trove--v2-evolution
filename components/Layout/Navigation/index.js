...
// import Link from "next/link"; // Commented out the import
...
const BurgerMenuButton = styled.div`
  ...
  @media (min-width: 600px) {
    display: none; /* Hide the burger menu button on screens wider than 600px */
  }
`;
...
const BurgerMenuLinks = styled.div`
  ...
  @media (min-width: 600px) {
    display: block; /* Always display the menu links on screens wider than 600px */
  }
`;
  ...
  return (
    <NavigationContainer>
      <NavigationList>
        ...
        <NavigationItem $active={router.pathname === "/create"}>
          {/* <Link href="/create"> */}
          <StyledNavigationSvg
            fillRule="evenodd"
            strokeLinejoin="round"
          ...
          {/* </Link> */}
          <NavigationItemText href="/create">Create Trip</NavigationItemText>
        </NavigationItem>
  ...
  return (
    <NavigationContainer>
      ...
      <BurgerMenuLinks isOpen={isOpen}>
        ...
        <BurgerMenuItem $active={router.pathname === "/create"}>
          {/* <Link href="/create"> */}
          <NavigationItemText href="/create">Create Trip</NavigationItemText>
          {/* </Link> */}
        </BurgerMenuItem>
